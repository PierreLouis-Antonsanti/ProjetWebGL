Player = function(game, canvas) {
  ...
  /*  this.axisMovement = [false,false,false,false];*/
    ...
    // On instancie la sensibilité angulaire
  ...
  var canvas = this.game.scene.getEngine().getRenderingCanvas(); //peut etre inutile
...
/*
   ...
   percentMove = this.camera.jumpNeed - this.camera.playerBox.position.y;
    ...
    up = new BABYLON.Vector3(0,percentMove/4 *  relativeSpeed,0);
           ...
           // this.jump+=0.02;
            // Axe de mouvement
           // up = new BABYLON.Vector3(0,this.jump,0);
    ...
    var targetHeight = 3;//trouver taille du joueur
